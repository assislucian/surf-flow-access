...
function PremiumCalendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-6 bg-gradient-to-br from-background/80 to-muted/50 backdrop-blur-sm rounded-xl border border-border/20", className)}
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 hover:bg-primary/20 border-border/30"
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 hover:bg-primary/20 transition-all duration-200"
        ),
