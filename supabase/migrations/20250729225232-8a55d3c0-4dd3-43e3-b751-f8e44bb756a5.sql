...
-- Create a unique index to prevent overlapping reservations (using space_id and duration)
CREATE UNIQUE INDEX idx_no_overlap_reservations 
ON public.reservations USING gist (space_id, duration);
...
-- Create function for user role checking to avoid infinite recursion
